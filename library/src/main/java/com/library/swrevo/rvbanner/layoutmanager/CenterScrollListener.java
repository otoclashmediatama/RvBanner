package com.library.swrevo.rvbanner.layoutmanager;
...
public class CenterScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        final OverFlyingLayoutManager.OnPageChangeListener onPageChangeListener = ((OverFlyingLayoutManager) Objects.requireNonNull(layoutManager)).onPageChangeListener;
